...
PACKAGE_CACHE_USERNAME = USER_SETTINGS['PACKAGE_CACHE_USERNAME']
PROXIES = {}
if 'HTTP_PROXY' in USER_SETTINGS and USER_SETTINGS['HTTP_PROXY']:
    PROXIES['http'] = USER_SETTINGS['HTTP_PROXY']
